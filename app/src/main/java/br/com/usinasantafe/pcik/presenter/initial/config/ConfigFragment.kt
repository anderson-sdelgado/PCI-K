...
import br.com.usinasantafe.pcik.utils.GenericDialogProgressBar
...
//            }
            buttonSalvarConfig.setOnClickListener {
                ...
                if(validate(nroEquip, senha)){
                    ...
                    viewModel.saveDataInitialConfig(nroEquip, senha, info.versionName)
    ...
    private fun handleStateChange(state: ConfigFragmentState){
        when(state){
            is ConfigFragmentState.RecoverConfigModel -> handleConfig(state.config)
